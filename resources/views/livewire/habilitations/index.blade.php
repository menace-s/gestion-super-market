                ...
                <table class="table dashboard-expired-products">
                    ...
                    <tbody >
                        ...
                        <tr>
                            ...
                            <td><span class="badge bg-success">{{ $user->allRoleNames }}</span></td>
                            <td>{{ $user->phone }}</td>
                            <td>{{ $user->created_at->diffForHumans() }}</td>
                            <td style='text-align:center;'>
                                <input type="checkbox" wire:change="toggleActivation({{ $user->id }})" {{ $user->is_active ? 'checked' : '' }}>
                            </td>
                            <td class="action-table-data" style="justify-content: center">
                                <div class="edit-delete-action" style="text-align: center">
                                    <a  wire:click="goToEditUser({{ $user->id }})" class="me-2 p-2" href="#">
